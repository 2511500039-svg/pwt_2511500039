...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <!-- Menu Guru tambahan sesuai instruksi dosen -->
            <?php if ($role == 'guru') : ?>
            <ul class="nav nav-treeview">
            ...
            <!-- Menu Siswa tambahan sesuai instruksi dosen -->
            <?php if ($role == 'siswa') : ?>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="#" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Profil</p></a></li>
              <li class="nav-item"><a href="#" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Jadwal</p></a></li>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">Pantang menyerah, walau sudah tahu pasti akan kalah.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="main-footer">
    <div class="float-right d-none d-sm-inline">Apapun yang kamu inginkan</div>
