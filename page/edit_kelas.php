...
<div class="form-group">
            ...
            <input type="text" name="id_kelas" value="<?= isset($edit['id_kelas']) ? $edit['id_kelas'] : ''; ?>" class="form-control" readonly>
        </div>
            <div class="form-group">
                <label for="nm_kelas">Nama Kelas</label>
                <input type="text" name="nm_kelas" value="<?= isset($edit['nm_kelas']) ? $edit['nm_kelas'] : ''; ?>" id="nm_kelas" placeholder="Nama kelas" class="form-control">
            </div>
