                ...
                <table class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=guru&action=hapus&kd_guru=<?= $row['kd_guru']; ?>" class="badge badge-danger">Hapus</a>
                                <a href="index.php?page=edit_guru&kd_guru=<?= $row['kd_guru']; ?>" class="badge badge-warning">Edit</a>
                            </td>
                        </tr>
                    <?php }} else { ?>
                        <tr>
